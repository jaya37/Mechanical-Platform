            ...
            >
              ...
              <form onSubmit={handleSubmit(async(data)=>{
                ...
                try {
                    ...
                    const res = axios.post(
                      `http://54.163.203.92:5000/payment`,
                      dataToSend
                    );
              ...
              <main class="mt-4 p-4">
                ...
                <div class="">
                  ...
                  <div class="my-3">
                    <input
                      type="tel" pattern='[0-9]{16}' title="please enter 16 numbers"
                  ...
                  <div class="my-3 flex flex-col">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      ...
                      <input 
                        type="tel"   pattern='[0-9]{3}' title="please enter 3 numbers"
