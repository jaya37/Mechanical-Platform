...
const Index = () => {
  return (
    <div>
      <MainNav />
      <div className="">
        <div className="bg-blue-400 p-8 h-4/5">
        <h2 className="text-2xl  underline font-bold italic text-white">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="col-start-8 col-span-12 mt-20">
            <img
              className="w-96 h-64"
              src="https://octet.design/wp-content/uploads/2021/12/Auto-service-booking.png"
            ></img>
          </div>
        </div>
        </div>
              ...
              <div class="flex flex-wrap -m-4">
                  ...
                  <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                    ...
                    <div class="flex-grow">
                      <p class="leading-relaxed text-base">
                        Our route map optimization feature gives users the
                        ability to track the mechanics
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="p-4 md:w-1/3">
                  <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                    ...
                    <div class="flex-grow">
                      <p class="leading-relaxed text-base">
                        A booking is the arrangement that you make when you book
                        something such as a car mechanic,bike mechanic
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <section class="text-gray-600 body-font relative">
            <div class="absolute inset-0 bg-gray-300">
              <iframe
                ...
                title="map"
                scrolling="no"
                src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=Saskatchewan&output=embed"
              ></iframe>
            </div>
