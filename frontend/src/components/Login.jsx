              ...
              if (data.role === "customer") {
                try {
                  const res = await axios.post(
                    `http://54.163.203.92:5000/customer/login`,
                    data
                  );
                ...
                try {
                  const res = await axios.post(
                    `http://54.163.203.92:5000/mechanic/login`,
                    data
                  );
            ...
            <div class="w-96 mt-4">
              <div class="relative h-10 w-full min-w-[200px]">
                ...
                <div className="flex justify-end">
                  <Link to={"/updatepassword"}> <a className="text-blue-900 font-bold text-right">Forgot Password ?</a></Link>
                </div>
              </div>
            </div>
            <div class="relative h-10  min-w-[200px] mt-7">
              <select
                {...register("role")}
