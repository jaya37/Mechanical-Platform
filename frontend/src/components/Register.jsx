  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-12">
        <div className="col-start-5 col-end-9 mt-5 p-8 shadow-lg">
          ...
          <form onSubmit={handleSubmit(async(data)=>{
            ...
            if(data.role == "customer"){
              try{
                const res = await axios.post(`http://54.163.203.92:5000/customer`,data);
            ...
            if(data.role == "mechanic"){
              try{
                const res = await axios.post(`http://54.163.203.92:5000/mechanic`,data);
                console.log(res.data)
                toast.success("Mechanic register successfully")
              }catch(error){
                toast.error(error.response.data.msg,{})
              }
            }
          ...
          <div class="w-96 mt-3">
            <div class="relative h-10 w-full min-w-[200px]">
              <input
                class="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                placeholder=" " pattern='[0-9]{10}' title="please enter ten numbers"
          ...
          <div class="relative h-10  min-w-[200px] mt-3">
            <select  {...register("role")}  class="peer block min-h-[auto] w-full rounded border-2 rounded bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0">
              <option value=""></option>
